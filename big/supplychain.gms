...
/
  ...
  ct(i,m,w,k) 'Per unit cost of shipment of product i from plant m to
warehouse w through transport mode k'  / $ondelim $include data_ct.csv
$offdelim /   ctt(i,w,j,k) 'Per unit cost of shipment of product i from
warehouse w to end-user j through transport mode k'  / $ondelim $include
data_ctt.csv $offdelim /
